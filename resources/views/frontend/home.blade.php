<section class="hero_single version_2" style="background: #222 url('uploads/system/home_banner.jpg') center center no-repeat; background-size: cover;">
	<div class="wrapper">
		<div class="container">
			<h3>
				<?php //echo get_frontend_settings('banner_title'); ?>!</h3>
			<p>
				<?php //echo get_frontend_settings('slogan'); ?>
			</p>
			<form action="<?php //echo site_url('home/search'); ?>" method="get">
				<div class="row no-gutters custom-search-input-2">
					<div class="col-lg-7">
						<div class="form-group">
							<input class="form-control" type="text" name="search_string" placeholder="<?php //echo get_phrase('what_are_you_looking_for'); ?>What are you looking for...">
					...
					<div class="col-lg-3">
						<select class="wide" name="selected_category_id">
							<option value="">
								<?php //echo get_phrase('all_categories'); ?>All categories
							</option>
							<?php
							//$categories = $this->crud_model->get_categories()->result_array();
							//foreach ($categories as $category):?>
								<option value="<?php //echo $category['id']; ?>1">
									<?php //echo $category['name']; ?>1
								</option>
								<?php //endforeach; ?>
						</select>
					</div>
...
<div class="bg_color_1">
	<div class="container margin_80_55">
		<div class="main_title_2">
			...
			<h2>
				<?php //echo get_phrase('popular_categories'); ?>Popular categories
			</h2>
			<p>
				<?php //echo get_phrase('popular_categories_wise_listing_is_down_below'); ?>
				...
				<div class="col-lg-4 col-md-6">
					<a href="<?php //echo site_url('home/filter_listings?category='.slugify($category['name']).'&&amenity=&&video=0&&status=all'); ?>"
						...
						<figure>
							...
							<div class="info">
								<small>
									<?php //echo count($this->frontend_model->get_category_wise_listings($category['id'])).' '.get_phrase('listings'); ?>
								</small>
								<h3>
...
<div class="container-fluid margin_80_55">
	<div class="main_title_2">
		...
		<h2>
			<?php //echo get_phrase('popular_listings'); ?>Popular listings
		</h2>
	</div>
		...
		<div class="item">
			<div class="strip grid">
				<figure>
					...
					<small>
						<?php //echo $listing['listing_type'] == "" ? ucfirst(get_phrase('general')) : ucfirst(get_phrase($listing['listing_type'])) ; ?>
					</small>
				</figure>
				<div class="wrapper">
					<h3>
					...
					<a class="address" href="http://maps.google.com/maps?q=<?php //echo $listing['latitude']; ?>,<?php //echo $listing['longitude']; ?>"
					    target="_blank">
						<?php //echo get_phrase('get_directions'); ?>Get directions
					</a>
				</div>
				<ul>
					<li>
					...
					<li>
						...
						?>
							...
							<strong>
								<?php //echo $this->frontend_model->get_listing_wise_rating($listing['id']); ?>
							</strong>
						</div>
					</li>
				</ul>
	...
	<div class="container">
		<div class="btn_home_align">
			<a href="<?php //echo site_url('home/listings'); ?>" class="btn_1 rounded">
				<?php //echo get_phrase('view_all'); ?>View all
			</a>
		</div>
	</div>
	<!-- /container -->
