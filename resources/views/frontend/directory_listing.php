<div class="hero_in shop_detail" style="background: url('uploads/listing_cover_photo/{{$listing_details['listing_cover']}}') center center no-repeat; background-size: cover;">
	<!-- <div class="wrapper">
		<span class="magnific-gallery">
			<?php foreach (json_decode($listing_details['photos']) as $key => $photo): ?>
				<a href="<?php echo base_url('uploads/listing_images/'.$photo); ?>" class="btn_photos" title="<?php echo $listing_details['name']; ?>" data-effect="mfp-zoom-in">
					<?php echo $key == 0 ? 'view_photos' : 'view_photos'; ?>
				</a>
			<?php endforeach; ?>
		</span>
	</div> -->
						...
						<ul class="magnific-gallery">
							<?php foreach (json_decode($listing_details['photos']) as $key => $photo): ?>
								<?php if (file_exists('uploads/listing_images/'.$photo)): ?>
									<li>
										<figure>
											<img src="uploads/listing_images/{{$photo}}" alt="">
											<figcaption>
												<div class="caption-content">
													<a href="uploads/listing_images/{{$photo}}" title="" data-effect="mfp-zoom-in">
