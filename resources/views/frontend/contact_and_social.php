<div class="row mb-3">
	<div class="col-12">
		...
		<?php if($listing_detail['website'] != ""){ ?>
			<a href="<?php echo $listing_detail['website']; ?>" target="blank" class="btn_1 full-width outline wishlist social-button" id = "btn-wishlist-social"><i class="icon-globe-6 mr-2"></i>Visit website</a>
		<?php } ?>
