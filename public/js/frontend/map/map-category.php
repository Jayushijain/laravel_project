...
function createListingsMap(options) {
    var defaults = {
        markerPath: 'uploads/images/marker.png',
        markerPathHighlight: 'uploads/images/marker-hover.png',
        markerShadow: 'uploads/images/location-pin.svg',
        imgBasePath: 'uploads/listing_thumbnails/',
        mapPopupType: 'venue',
        useTextIcon: false
    }
